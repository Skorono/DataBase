...
begin
  ...
  begin
    ...
    begin
      ...
      if  ((isMore(previousText, currentText) and not (previousText[1] = ' ')) then   // если номер элемента в сортировке выше предыдущего то он идёт в вверх в таблице (например: a < b, то a будет выше)
      begin
